...
<p align="center">
  <a href="https://github.com/luodaoyi/Certwarden/releases/tag/v1.3.2"><img src="https://img.shields.io/github/v/release/luodaoyi/Certwarden?display_name=tag&style=flat-square" alt="Latest release" /></a>
  <a href="https://github.com/luodaoyi/Certwarden/releases/tag/v1.3.2"><img src="https://img.shields.io/github/release-date/luodaoyi/Certwarden?style=flat-square" alt="Release date" /></a>
...
<p align="center">
  ...
  <a href="https://github.com/luodaoyi/Certwarden/releases/tag/v1.3.2"><strong>版本发布</strong></a> ·
...
- [v1.3.2 版本说明](https://github.com/luodaoyi/Certwarden/releases/tag/v1.3.2)
...
```bash
CERTWARDEN_IMAGE=ghcr.io/luodaoyi/certwarden:v1.3.2
```
...
| `SCAN_INTERVAL` | 证书检测成功后的默认复检周期 | `2h` |
| `SMTP_*` | SMTP 配置 | 空 |
